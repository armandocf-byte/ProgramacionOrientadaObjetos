...
public class AlumnoDAO {
    ...
    public boolean nuevoAlumno(Alumno alumno){
        ...
        String sql = "INSERT INTO alumnos (numExpediente, nombre, edad, carrera, cuatrimestre, curp) VALUES (?,?,?,?,?,?)";
        ...
        try(Connection conexion = Conexion.conectar();
            ...
            stm.setString(6, alumno.getCurp()); // Parámetro 6: CURP
    ...
    public boolean actualizarAlumno(Alumno alumno){
        ...
        // Agregamos ", curp = ?" al SET (Ahora son 6 parámetros en total)
        ...
        try (Connection conexion = Conexion.conectar();
            ...
            stm.setInt(6, alumno.getNumeroExpediente());
